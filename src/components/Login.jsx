...
export default function Login() {
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", background: "#f6fbf7", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem 1rem" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: 400, background: "rgba(255,255,255,.94)", border: "0.5px solid rgba(0,132,61,.14)", borderRadius: 24, padding: "40px", backdropFilter: "blur(24px)" }}>
        
        <h2 style={{ fontSize: 32, fontWeight: 800, color: "#12351f", marginBottom: 8, textAlign: "center" }}>Bienvenue sur <span style={{ color: "#00843d" }}>YallaHEMSI</span></h2>
        <p style={{ color: "rgba(18,53,31,.55)", marginBottom: 30, textAlign: "center" }}>Connectez-vous à votre compte.</p>
        ...
        <p style={{ textAlign: "center", marginTop: 20, color: "rgba(18,53,31,.55)", fontSize: 14 }}>
          Vous n'avez pas de compte ? <Link to="/inscription" style={{ color: "#00843d", textDecoration: "none", fontWeight: 700 }}>S'inscrire ici</Link>
        </p>
      </div>
    </div>
  );
